 ...
 */
export function PhilipGizzieEnvProvider({ children }: { children: React.ReactNode }) {
  return <PhilipGizzieTheme>{children}</PhilipGizzieTheme>;
}
 ...
 */
export default createMounter(PhilipGizzieEnvProvider) as any;